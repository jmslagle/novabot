    ...
    RTConfig.PropertySetter, RTConfig.PropertyGetter
{
  ...
  //public  static final char    NameSeparatorChar          = ':';
    ...
    private static Set<Object> TracePropertyKeySet = null;

    public static void AddPropertyKeyTrace(Object key)
    {
        if (key != null) {
            if (TracePropertyKeySet == null) {
                TracePropertyKeySet = new HashSet<Object>();
            }
            TracePropertyKeySet.add(key);
            Print.logInfo("Tracing Property Key: " + key);
        }
    }

    public static void CheckPropertyKeyTrace(Object key, String msg)
    {
        if ((TracePropertyKeySet != null) && TracePropertyKeySet.contains(key)) {
            Print.logStackTrace(msg+" Property Key: " + key);
        }
    }

    static {
        //AddPropertyKeyTrace("some.key");
    }
    ...
    **/
    ...
    /**
    *** Constructor
    *** @param props  A String containing "NAME: key=value key=value ..." specifications used to
    ***               initialize this instance.
    **/
    public RTProperties(String props)
    {
        this();
        this.setProperties(props, true/*inclName*/);
    }
    ...
    **/
    ...
    /**
    *** Sets the DebugName of this RTProperties instance.<br>
    *** Used for debug purposes in RTConfig to provide the tracing of locations
    *** where a specific property key is found.
    *** @param dn  The debug name
    **/
    public RTProperties setDebugName(String dn)
    {
        this.debugName = StringTools.trim(dn);
        return this;
    }

    /**
    *** Gets the DebugName of this RTProperties instance
    ...
    **/
    ...
    /**
    *** Returns true if the DebugName for this instance has been defined
    *** @return True if DebugName has been defined
    **/
    public boolean hasDebugName()
    {
        return !StringTools.isBlank(this.getDebugName());
    }
    ...
    **/
    public RTProperties setIgnoreKeyCase(boolean ignCase)
    {
        ...
        Object props = this.getProperties();
    ...
    **/
    protected void firePropertyChanged(Object key, Object oldVal)
    {
        if (this.changeListeners != null) {
            ...
            for (Iterator<PropertyChangeListener> i = this.changeListeners.iterator(); i.hasNext();) {
    ...
    **/
    public void removeProperty(Object key)
    {
        if (key != null) {
            ...
            /* trace */
            CheckPropertyKeyTrace(key,"Remove");
    ...
    *** @see #_insertKeyValues(Object mainKey, String text)
    *** @see StringTools#insertKeyValues
    **/
    ...
    **/
    public boolean equals(Object other)
    {
        if (other instanceof RTProperties) {
            ...
            if (M1.size() == M2.size()) {
                for (Iterator<Object> i = M1.keySet().iterator(); i.hasNext();) {
                    Object key = i.next();
    ...
    **/
        ...
        throws IOException
    {
        ...
        if (merge && cfgFile.exists()) {
            ...
            for (Iterator<Object> i = propMap.keySet().iterator(); i.hasNext();) {
    ...
    **/
    public String[] toStringArray(boolean dashPrefix)
    {
        ...
        for (Object keyObj : propMap.keySet()) {
            ...
            /* trace */
            CheckPropertyKeyTrace(keyObj,"Remove");
            ...
            if (ks.startsWith(RTKey.CONSTANT_PREFIX)) { // %...
                ...
                if (ks.equalsIgnoreCase(KEY_LOG)) {
                    if (RTProperties.this.getConfigLogMessagesEnabled()) {
                        ...
                        tempProps.setDebugName("ParseTemp.Log["+this.inputURL+"]");
