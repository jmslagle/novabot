    ...
    implements Set<K>, java.util.List<K>, Cloneable
{
    ...
    **/
    ...
    /**
    *** Create/Return Spliterator class.<br>
    *** Required to prevent compiler error in Java 8
    **/
    /* Java-8 only * /
    @Override
    public Spliterator<K> spliterator() 
    {
        return Spliterators.spliterator((List<K>)this, Spliterator.ORDERED); // as List
      //return Spliterators.spliterator((Set<K>)this, Spliterator.DISTINCT); // as Set
    }
    /* */
