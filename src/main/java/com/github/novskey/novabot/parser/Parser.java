...
public class Parser {
    ...
    private Argument getArg(final String s) {
    ...
    private Argument parseList(final String group) {
        final Argument argument = new Argument();
    ...
    public static void main(String[] args) {
        ...
        UserCommand command = novaBot.parser.parseInput("!stats ludicolo 1 année");
        System.out.println(command);
    }

    static {
        PATTERN = Pattern.compile("(?=\\S*[.'-])|!?(\\w|é)+|<(.*?)>");
    }
}
