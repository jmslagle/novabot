...
public class RTConfig
{
    ...
    **/
    public static void printThreadProperties(String msg)
    {
        ...
        if (!didPrint) {
            Print.sysPrintln(msg + " (no thread properties)");
        }
    }
    ...
    *** the specified key
    **/
    public static RTProperties getThreadProperties(String key)
    {
    ...
    **/
    public static void pushThreadProperties(RTProperties props)
    {
        ...
        //Print.logStackTrace("Pushing Temporary Properties");
        rtpStack.push(props);
    ...
    **/
    public static void popThreadProperties(RTProperties props)
    {
    ...
    *** current thread
    **/
    public static void popAllThreadProperties()
    {
    ...
    **/
    public static int getThreadPropertiesStackSize()
    {
        if (CFG_THREAD_TEMPORARY != null) {
            Stack<RTProperties> rtpStack = CFG_THREAD_TEMPORARY.get();
    ...
    **/
    public static RTProperties _getThreadProperties()
    {
        if (RTConfig.isTrueServlet()) {
            // -- This should not be used within Tomcat, because there is no way to effectively
            // -  clean up the ThreadLocal instances when the "track.war" file is undeployed.
            Print.logWarn("Using ThreadLocal Properties within a web-servlet!!");
        }
        // --
        if (CFG_PROPERTIES[THREAD_LOCAL] == null) {
            synchronized (CFG_PROPERTIES) {
                if (CFG_PROPERTIES[THREAD_LOCAL] == null) {
                    CFG_PROPERTIES[THREAD_LOCAL] = new RTProperties(new ThreadLocalMap<Object,Object>("RTConfig"));
                    CFG_PROPERTIES[THREAD_LOCAL].setDebugName("ThreadLocal");
                }
            }
        }
        ...
        if (CFG_PROPERTIES[RUNTIME_CONSTANT] == null) {
            synchronized (CFG_PROPERTIES) {
                if (CFG_PROPERTIES[RUNTIME_CONSTANT] == null) {
                    ...
                    CFG_PROPERTIES[RUNTIME_CONSTANT].setDebugName("RuntimeConstant");
                }
            }
        }
    ...
    **/
    public static RTProperties getConfigFileProperties()
    {
        ...
        if (CFG_PROPERTIES[CONFIG_FILE] != null) {
            ...
            RTProperties fileRTP = new RTProperties();
            fileRTP.setDebugName("TempFile(empty)");
            return fileRTP;
        }
    }
    ...
    **/
    public static RTProperties getPropertiesForKey(String key, boolean dftOk)
    {
        if (key != null) {
            ...
            RTProperties tempProps = RTConfig.getThreadProperties(key);
            if (tempProps != null) {
                //if (key.equals(testKey)) System.out.println("RTConfig.getPropertiesForKey: Found "+testKey+" @ " + getThreadProperties());
                return tempProps;
            }
    ...
    **/
    public static String findPropertiesForKey(String key)
    {
        if (key != null) {
            ...
            if (tempProps != null) {
                String pn = "Temporary";
                return tempProps.hasDebugName()? (pn+":"+tempProps.getDebugName()) : pn;
            }
            ...
            for (int i = 0; i < CFG_PROPERTIES.length; i++) {
                RTProperties rtProps = CFG_PROPERTIES[i];
                if ((rtProps != null) && rtProps.hasProperty(key)) {
                    String pn = getConfigPropertiesIndexName(i); 
                    return rtProps.hasDebugName()? (pn+":"+rtProps.getDebugName()) : pn;
                }
            }
            ...
            if ((dftProps != null) && dftProps.hasProperty(key)) {
                String pn = "Defaults";
                return dftProps.hasDebugName()? (pn+":"+dftProps.getDebugName()) : pn;
            }
    ...
    **/
    public static int setCommandLineArgs(String argv[], String keyAttr[])
    {
        ...
        cmdArgs.setDebugName("CommandLine");
    ...
    **/
    public static void setCommandLineArgs(RTProperties cmdLineProps)
    {
        if (cmdLineProps != null) {
            ...
            RTProperties commandRTP = new RTProperties();
            commandRTP.setDebugName("CommandLine(empty)");
            RTConfig.setCommandLineArgs(commandRTP, false);
        }
    }
    ...
    public static void setCommandLineArgs(RTProperties cmdLineProps, boolean testMode)
    {
        if (cmdLineProps != null) {
            ...
            if (CFG_PROPERTIES[COMMAND_LINE] == null) {
                ...
                CFG_PROPERTIES[COMMAND_LINE].setDebugName("CommandLine[external]");
    ...
    **/
    public static void _setServletContextProperties(RTProperties props)
    {
        ...
        CFG_PROPERTIES[SERVLET_CONTEXT].setDebugName("ServletContext[external]");
    }
    ...
    **/
    public static void setServletContextProperties(Map<Object,Object> props)
    {
        ...
        RTProperties serletRTP = new RTProperties(props);
        serletRTP.setDebugName("ServletContext");
        RTConfig._setServletContextProperties(serletRTP);
    ...
    **/
    protected static synchronized void _startupInit(boolean allowChangeSystemProperties)
    {
        ...
        if (_allowSysPropChange) {
            ...
            for (Iterator<String> i = RTKey.getRuntimeKeyIterator(); i.hasNext();) {
                String key = i.next();
                try {
        ...
        CFG_PROPERTIES[SYSTEM_PROPS].setDebugName("SystemProps");
        ...
        if (RTConfig.getEnvironmentVariablesEnabled()) {
            try {
                ...
                CFG_PROPERTIES[ENVIRONMENT].setDebugName("Environment");
        ...
        if (_foundConfigURL != null) {
            ...
            CFG_PROPERTIES[CONFIG_FILE].setDebugName("ConfigFile["+_foundConfigURL+"]");
            if (RTConfig.verbose) { 
            ...
            CFG_PROPERTIES[CONFIG_FILE].setDebugName("ConfigFile[empty]");
            if (RTConfig.verbose) { 
        ...
        /* Java-7/8 SSL bug work-around */
        // -- ie. "javax.net.ssl.SSLProtocolException: handshake alert:  unrecognized_name"
        if (RTConfig.getBoolean(RTKey.DISABLE_SNI_EXTENSION)) { // ssl.disableSNIExtension=true
            System.setProperty("jsse.enableSNIExtension", "false");
            Print.logDebug("Disabled SNI Extension (Java 7/8 bug work-around)");
        }
    ...
    **/
    public static RTProperties getProperties(String startsWith, boolean inclDft)
    {
        ...
        rtProps.setDebugName("StartsWith["+startsWith+"]");
        for (String k : keys) {
    ...
    **/
    public static void main(String argv[])
    {
        ...
        if(RTConfig.hasProperty("merge")) {
            ...
            mergeP.setDebugName("Merge["+mergeFile+"==>"+intoFile+"]");
            try {
        ...
        RTConfig.popThreadProperties(tempProps);
        Print.logInfo("Main Label = " + RTConfig.getString(GETLABEL));
        /* */
