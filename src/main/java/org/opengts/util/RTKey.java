...
//  2016/05/10  Martin D. Flynn
//     -Fixed DB_INCLUDE_LAST_UPDATE_ACCT (removed trailing "r")
// ----------------------------------------------------------------------------
    ...
    implements Comparable<RTKey>
{
    ...
    public static final String DISABLE_SNI_EXTENSION        = "ssl.disableSNIExtension"; // true|false (sets "jsse.enableSNIExtension=false")
    ...
    public static final String SMTP_MULTIPART_TYPE          = "smtp.multipartType"; // [2.6.2-B52]
    public static final String SMTP_BCC_EMAIL               = "smtp.bcc.emailAddress"; // may not be supported
    public static final String SMTP_SYSADMIN_EMAIL          = "smtp.sysadmin.emailAddress";
    ...
    public static final String DB_INCLUDE_LAST_UPDATE_ACCT  = "db.includeLastUpdateAccount";        // Boolean
    ...
    public static final String DB_EMAIL_CONNECTION_ERRORS   = "db.emailConnectionErrors";           // Boolean
    ...
    public static final String _DB_RECORD_LISTENER          = ".recordListener";                    // String (Suffix)
    ...
    protected static Entry runtimeKeys[] = {
        ...
        new Entry("Java 7/8 SNI bug work-around"),
        new Entry(DISABLE_SNI_EXTENSION      , false                            , "Disable SNI Extension (Java bug work-around)"), // APP|WEB
        ...
        new Entry(SMTP_SERVER_TIMEOUT_MS     , 0                                , "SMTP Connection Timeout MS"),                // APP|WEB
        new Entry(SMTP_SERVER_RETRY_COUNT    , 0                                , "SMTP Retry Count"),                          // APP|WEB
        new Entry(SMTP_MULTIPART_TYPE        , null                             , "SMTP Multipart MIME Type"),                  // APP|WEB
        new Entry(SMTP_BCC_EMAIL             , null                             , "SMTP BCC Email address"),                    // APP|WEB
        new Entry(SMTP_SYSADMIN_EMAIL        , null                             , "SMTP System Admin Email address"),           // APP|WEB
        ...
        new Entry(LOG_EMAIL_EXCEPTIONS       , false                            , "EMail exceptions (not used)"),               // APP|WEB
        new Entry(LOG_EMAIL_FROM             , null                             , "Error email sender (not used)"),
        new Entry(LOG_EMAIL_TO               , null                             , "Error email recipient (not used)"),
        new Entry(LOG_SENDMAIL_CLASS         , SENDMAIL_CLASS()                 , "Sendmail class name (not used)"),            // APP|WEB

        new Entry("DB attributes"),
        new Entry(DB_DBCONNECTION_POOL       , true                             , "DBConnection Pooling"),                      // APP|WEB
        ...
        new Entry(DB_EMAIL_CONNECTION_ERRORS , false                            , "EMail connection errors to sysadmin"),       // APP|WEB
